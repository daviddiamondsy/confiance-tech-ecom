...
export async function ensureCatalogSchema(): Promise<void> {
  ...
  await sqlDdl`
    ALTER TABLE products
    ADD COLUMN IF NOT EXISTS international_shipping_ngn INTEGER NOT NULL DEFAULT 25000
  `;
  await sqlDdl`
    ALTER TABLE products
  ...
  await sqlDdl`
    ALTER TABLE products
    ADD COLUMN IF NOT EXISTS international_shipping_currency TEXT NOT NULL DEFAULT 'ngn'
  `;
  await sqlDdl`
    ALTER TABLE products
    ADD COLUMN IF NOT EXISTS international_shipping_usd INTEGER NOT NULL DEFAULT 15
  `;
  await sqlDdl`
    ALTER TABLE products
  ...
  await sqlDdl`
    ALTER TABLE products
    ADD COLUMN IF NOT EXISTS variant_dimension TEXT NOT NULL DEFAULT 'storage'
  `;
  await sqlDdl`
    ALTER TABLE products
    ADD COLUMN IF NOT EXISTS price_mode TEXT NOT NULL DEFAULT 'calculated'
  `;
